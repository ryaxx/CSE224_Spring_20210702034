module ALU (A,
 ...
 sky130_fd_sc_hd__a21o_1 _096_ (.A1(net1),
    ...
    .B1(net9),
    .X(_029_));
 sky130_fd_sc_hd__nor2b_4 _097_ (.A(net19),
    .B_N(net18),
    .Y(_030_));
 sky130_fd_sc_hd__or2_1 _098_ (.A(net1),
    .B(net17),
    .X(_031_));
 sky130_fd_sc_hd__or3b_1 _099_ (.A(net18),
    .B(net17),
    .C_N(net19),
    .X(_032_));
 sky130_fd_sc_hd__buf_2 _100_ (.A(_032_),
    .X(_033_));
 sky130_fd_sc_hd__or2_1 _101_ (.A(net19),
    .B(net18),
    .X(_034_));
 sky130_fd_sc_hd__nand3b_4 _102_ (.A_N(net18),
    .B(net17),
    .C(net19),
    .Y(_035_));
 sky130_fd_sc_hd__or2b_1 _103_ (.A(net1),
    .B_N(net9),
    .X(_036_));
 sky130_fd_sc_hd__or2b_1 _104_ (.A(net9),
    .B_N(net1),
    .X(_037_));
 sky130_fd_sc_hd__a22o_1 _105_ (.A1(_034_),
    .A2(_035_),
    .B1(_036_),
    .B2(_037_),
    .X(_038_));
 sky130_fd_sc_hd__o21ai_1 _106_ (.A1(net1),
    .A2(_033_),
    .B1(_038_),
    .Y(_039_));
 sky130_fd_sc_hd__a31o_1 _107_ (.A1(_029_),
    .A2(_030_),
    .A3(_031_),
    .B1(_039_),
    .X(net20));
 sky130_fd_sc_hd__or3b_4 _108_ (.A(net18),
    .B(net19),
    .C_N(net17),
    .X(_040_));
 sky130_fd_sc_hd__buf_6 _109_ (.A(_040_),
    .X(_041_));
 sky130_fd_sc_hd__a21oi_1 _110_ (.A1(net9),
    .A2(net28),
    .B1(net10),
    .Y(_042_));
 sky130_fd_sc_hd__and3_1 _111_ (.A(_041_),
    .B(net10),
    .C(net9),
    .X(_043_));
 sky130_fd_sc_hd__o21ai_2 _112_ (.A1(_042_),
    .A2(_043_),
    .B1(net2),
    .Y(_044_));
 sky130_fd_sc_hd__or3_4 _113_ (.A(net2),
    .B(_042_),
    .C(_043_),
    .X(_045_));
 sky130_fd_sc_hd__a21oi_1 _114_ (.A1(_044_),
    .A2(_045_),
    .B1(_036_),
    .Y(_046_));
 sky130_fd_sc_hd__a31o_1 _115_ (.A1(_036_),
    .A2(_044_),
    .A3(_045_),
    .B1(_034_),
    .X(_047_));
 sky130_fd_sc_hd__and2_1 _116_ (.A(net17),
    .B(_030_),
    .X(_048_));
 sky130_fd_sc_hd__a21oi_1 _117_ (.A1(net2),
    .A2(net10),
    .B1(_035_),
    .Y(_049_));
 sky130_fd_sc_hd__o22a_1 _118_ (.A1(net2),
    .A2(net10),
    .B1(_048_),
    .B2(_049_),
    .X(_050_));
 sky130_fd_sc_hd__nor2_1 _119_ (.A(net2),
    .B(_033_),
    .Y(_051_));
 sky130_fd_sc_hd__a311o_1 _120_ (.A1(net2),
    .A2(net10),
    .A3(_030_),
    .B1(_050_),
    .C1(_051_),
    .X(_052_));
 sky130_fd_sc_hd__o21bai_1 _121_ (.A1(_046_),
    .A2(_047_),
    .B1_N(_052_),
    .Y(net21));
 sky130_fd_sc_hd__a21bo_4 _122_ (.A1(_036_),
    .A2(_045_),
    .B1_N(_044_),
    .X(_053_));
 sky130_fd_sc_hd__o21a_1 _123_ (.A1(net9),
    .A2(net10),
    .B1(_041_),
    .X(_054_));
 sky130_fd_sc_hd__xnor2_2 _124_ (.A(net11),
    .B(_054_),
    .Y(_055_));
 sky130_fd_sc_hd__xor2_1 _125_ (.A(net3),
    .B(_055_),
    .X(_056_));
 sky130_fd_sc_hd__and2_1 _126_ (.A(_053_),
    .B(_056_),
    .X(_057_));
 sky130_fd_sc_hd__nor2_1 _127_ (.A(net19),
    .B(net18),
    .Y(_058_));
 sky130_fd_sc_hd__o21ai_1 _128_ (.A1(_053_),
    .A2(_056_),
    .B1(_058_),
    .Y(_059_));
 sky130_fd_sc_hd__a21oi_1 _129_ (.A1(net3),
    .A2(net11),
    .B1(_035_),
    .Y(_060_));
 sky130_fd_sc_hd__o22a_1 _130_ (.A1(net3),
    .A2(net11),
    .B1(_048_),
    .B2(_060_),
    .X(_061_));
 sky130_fd_sc_hd__nor2_1 _131_ (.A(net3),
    .B(_033_),
    .Y(_062_));
 sky130_fd_sc_hd__a311o_1 _132_ (.A1(net3),
    .A2(net11),
    .A3(_030_),
    .B1(_061_),
    .C1(_062_),
    .X(_063_));
 sky130_fd_sc_hd__o21bai_1 _133_ (.A1(_057_),
    .A2(_059_),
    .B1_N(_063_),
    .Y(net22));
 sky130_fd_sc_hd__or3_4 _134_ (.A(net9),
    .B(net10),
    .C(net11),
    .X(_064_));
 sky130_fd_sc_hd__a21bo_1 _135_ (.A1(_041_),
    .A2(_064_),
    .B1_N(net12),
    .X(_065_));
 sky130_fd_sc_hd__nand3b_1 _136_ (.A_N(net12),
    .B(net28),
    .C(_064_),
    .Y(_066_));
 ...
 sky130_fd_sc_hd__nor2_1 _139_ (.A(_067_),
    .B(_068_),
    .Y(_069_));
 sky130_fd_sc_hd__a21oi_1 _140_ (.A1(net3),
    .A2(_055_),
    .B1(_057_),
    .Y(_070_));
 sky130_fd_sc_hd__xnor2_1 _141_ (.A(_069_),
    .B(_070_),
    .Y(_071_));
 sky130_fd_sc_hd__nor2_1 _142_ (.A(net4),
    .B(_033_),
    .Y(_072_));
 sky130_fd_sc_hd__a31o_1 _143_ (.A1(net4),
    .A2(net12),
    .A3(_030_),
    .B1(_072_),
    .X(_073_));
 sky130_fd_sc_hd__a21oi_1 _144_ (.A1(net4),
    ...
    .B1(_035_),
    .Y(_074_));
 sky130_fd_sc_hd__o22a_1 _145_ (.A1(net4),
    .A2(net12),
    .B1(_048_),
    .B2(_074_),
    .X(_075_));
 sky130_fd_sc_hd__a211o_1 _146_ (.A1(_058_),
    .A2(_071_),
    .B1(_073_),
    .C1(_075_),
    .X(net23));
 sky130_fd_sc_hd__a21o_1 _147_ (.A1(net5),
    .A2(net13),
    .B1(_035_),
    .X(_076_));
 sky130_fd_sc_hd__a21o_1 _148_ (.A1(net5),
    .A2(net13),
    .B1(net17),
    .X(_077_));
 sky130_fd_sc_hd__nand2_1 _149_ (.A(_030_),
    .B(_077_),
    .Y(_078_));
 sky130_fd_sc_hd__a2bb2o_1 _150_ (.A1_N(net5),
    .A2_N(net13),
    .B1(_076_),
    .B2(_078_),
    .X(_079_));
 sky130_fd_sc_hd__o21a_1 _151_ (.A1(net12),
    .A2(_064_),
    .B1(_041_),
    .X(_080_));
 sky130_fd_sc_hd__xnor2_1 _152_ (.A(net13),
    .B(_080_),
    .Y(_081_));
 sky130_fd_sc_hd__and2_1 _153_ (.A(net5),
    .B(_081_),
    .X(_082_));
 sky130_fd_sc_hd__nor2_1 _154_ (.A(net5),
    .B(_081_),
    .Y(_083_));
 sky130_fd_sc_hd__nor2_1 _155_ (.A(_082_),
    .B(_083_),
    .Y(_084_));
 sky130_fd_sc_hd__a21o_1 _156_ (.A1(_065_),
    .A2(_066_),
    .B1(net4),
    .X(_085_));
 sky130_fd_sc_hd__a31o_1 _157_ (.A1(net3),
    .A2(_055_),
    .A3(_085_),
    .B1(_068_),
    .X(_086_));
 sky130_fd_sc_hd__a31o_1 _158_ (.A1(_053_),
    .A2(_056_),
    .A3(_069_),
    .B1(_086_),
    .X(_087_));
 sky130_fd_sc_hd__nor2_1 _159_ (.A(_084_),
    .B(_087_),
    .Y(_088_));
 sky130_fd_sc_hd__and2_4 _160_ (.A(_087_),
    .B(_084_),
    .X(_089_));
 sky130_fd_sc_hd__o32a_1 _161_ (.A1(_034_),
    .A2(_088_),
    .A3(_089_),
    .B1(_033_),
    .B2(net5),
    .X(_090_));
 sky130_fd_sc_hd__nand2_1 _162_ (.A(_079_),
    .B(_090_),
    .Y(net24));
 sky130_fd_sc_hd__a21o_1 _163_ (.A1(net13),
    .A2(_041_),
    .B1(_080_),
    .X(_091_));
 sky130_fd_sc_hd__nor2_1 _164_ (.A(net14),
    .B(_091_),
    .Y(_092_));
 sky130_fd_sc_hd__and2_1 _165_ (.A(net14),
    .B(_091_),
    .X(_093_));
 sky130_fd_sc_hd__or3_2 _166_ (.A(net6),
    .B(_092_),
    .C(_093_),
    .X(_094_));
 sky130_fd_sc_hd__o21ai_1 _167_ (.A1(_092_),
    .A2(_093_),
    .B1(net6),
    .Y(_095_));
 sky130_fd_sc_hd__a211o_1 _168_ (.A1(_094_),
    .A2(_095_),
    .B1(_082_),
    .C1(_089_),
    .X(_000_));
 sky130_fd_sc_hd__o211ai_1 _169_ (.A1(_082_),
    .A2(_089_),
    .B1(_094_),
    .C1(_095_),
    .Y(_001_));
 sky130_fd_sc_hd__a21oi_1 _170_ (.A1(net6),
    .A2(net14),
    .B1(_035_),
    .Y(_002_));
 sky130_fd_sc_hd__o22a_1 _171_ (.A1(net6),
    .A2(net14),
    .B1(_048_),
    .B2(_002_),
    .X(_003_));
 sky130_fd_sc_hd__nor2_1 _172_ (.A(net6),
    .B(_033_),
    .Y(_004_));
 sky130_fd_sc_hd__a311o_1 _173_ (.A1(net6),
    .A2(net14),
    .A3(_030_),
    .B1(_003_),
    .C1(_004_),
    .X(_005_));
 sky130_fd_sc_hd__a31o_1 _174_ (.A1(_058_),
    .A2(_000_),
    .A3(_001_),
    .B1(_005_),
    .X(net25));
 sky130_fd_sc_hd__o21a_1 _175_ (.A1(net14),
    .A2(_091_),
    .B1(net28),
    .X(_006_));
 sky130_fd_sc_hd__xnor2_1 _176_ (.A(net15),
    .B(_006_),
    .Y(_007_));
 sky130_fd_sc_hd__xor2_1 _177_ (.A(net7),
    .B(_007_),
    .X(_008_));
 sky130_fd_sc_hd__o21a_1 _178_ (.A1(_092_),
    .A2(_093_),
    .B1(net6),
    .X(_009_));
 sky130_fd_sc_hd__o31a_1 _179_ (.A1(_082_),
    .A2(_089_),
    .A3(_009_),
    .B1(_094_),
    .X(_010_));
 sky130_fd_sc_hd__or2_1 _180_ (.A(_008_),
    .B(_010_),
    .X(_011_));
 sky130_fd_sc_hd__o311a_4 _181_ (.A1(_082_),
    .A2(_009_),
    .A3(_089_),
    .B1(_008_),
    .C1(_094_),
    .X(_012_));
 sky130_fd_sc_hd__nor2_1 _182_ (.A(_034_),
    .B(_012_),
    .Y(_013_));
 sky130_fd_sc_hd__a21oi_1 _183_ (.A1(net7),
    .A2(net15),
    .B1(_035_),
    .Y(_014_));
 sky130_fd_sc_hd__o22a_1 _184_ (.A1(net7),
    .A2(net15),
    .B1(_048_),
    .B2(_014_),
    .X(_015_));
 sky130_fd_sc_hd__nor2_1 _185_ (.A(net7),
    .B(_033_),
    .Y(_016_));
 sky130_fd_sc_hd__a311o_1 _186_ (.A1(net7),
    .A2(net15),
    .A3(_030_),
    .B1(_015_),
    .C1(_016_),
    .X(_017_));
 sky130_fd_sc_hd__a21o_1 _187_ (.A1(_011_),
    .A2(_013_),
    .B1(_017_),
    .X(net26));
 sky130_fd_sc_hd__and2_1 _188_ (.A(net7),
    .B(_007_),
    .X(_018_));
 sky130_fd_sc_hd__nand2_1 _189_ (.A(net8),
    .B(net16),
    .Y(_019_));
 sky130_fd_sc_hd__or2_1 _190_ (.A(net8),
    .B(net16),
    .X(_020_));
 sky130_fd_sc_hd__nand2_1 _191_ (.A(_019_),
    .B(_020_),
    .Y(_021_));
 sky130_fd_sc_hd__o21ai_1 _192_ (.A1(net15),
    .A2(_006_),
    .B1(net28),
    .Y(_022_));
 sky130_fd_sc_hd__xnor2_1 _193_ (.A(_021_),
    .B(_022_),
    .Y(_023_));
 sky130_fd_sc_hd__o21ai_1 _194_ (.A1(_018_),
    .A2(_012_),
    .B1(_023_),
    .Y(_024_));
 sky130_fd_sc_hd__or3_4 _195_ (.A(_018_),
    .B(_012_),
    .C(_023_),
    .X(_025_));
 sky130_fd_sc_hd__a21o_1 _196_ (.A1(net8),
    .A2(net16),
    .B1(net17),
    .X(_026_));
 sky130_fd_sc_hd__o22ai_1 _197_ (.A1(net8),
    .A2(_033_),
    .B1(_021_),
    .B2(_035_),
    .Y(_027_));
 sky130_fd_sc_hd__a31o_1 _198_ (.A1(_030_),
    .A2(_020_),
    .A3(_026_),
    .B1(_027_),
    .X(_028_));
 sky130_fd_sc_hd__a31o_4 _199_ (.A1(_025_),
    .A2(_024_),
    .A3(_058_),
    .B1(_028_),
    .X(net27));
 ...
 sky130_fd_sc_hd__buf_6 output27 (.A(net27),
    .X(out[7]));
 sky130_fd_sc_hd__buf_2 clone1 (.A(net29),
    .X(net28));
 sky130_fd_sc_hd__clkbuf_1 rebuffer2 (.A(net30),
    .X(net29));
 sky130_fd_sc_hd__clkbuf_1 rebuffer3 (.A(_040_),
    .X(net30));
 ...
 sky130_fd_sc_hd__decap_4 FILLER_0_1_23 ();
 ...
 sky130_fd_sc_hd__decap_4 FILLER_0_3_19 ();
 ...
 sky130_fd_sc_hd__decap_4 FILLER_0_3_71 ();
 ...
 sky130_fd_sc_hd__fill_1 FILLER_0_4_11 ();
 sky130_fd_sc_hd__decap_6 FILLER_0_4_17 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_0_6_17 ();
 sky130_fd_sc_hd__decap_6 FILLER_0_6_22 ();
 sky130_fd_sc_hd__fill_2 FILLER_0_6_29 ();
 sky130_ef_sc_hd__decap_12 FILLER_0_6_34 ();
 ...
 sky130_fd_sc_hd__decap_3 FILLER_0_8_10 ();
 ...
 sky130_fd_sc_hd__decap_4 FILLER_0_12_99 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_0_13_61 ();
