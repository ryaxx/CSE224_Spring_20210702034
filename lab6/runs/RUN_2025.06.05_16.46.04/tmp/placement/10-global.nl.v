module TopModule (clk,
 ...
 sky130_fd_sc_hd__or2_2 _070_ (.A(\display_module.pos[0] ),
    .B(\display_module.pos[1] ),
    .X(_036_));
 sky130_fd_sc_hd__buf_1 _071_ (.A(_036_),
    .X(an[0]));
 sky130_fd_sc_hd__or2b_2 _072_ (.A(\display_module.pos[1] ),
    .B_N(\display_module.pos[0] ),
    .X(_037_));
 sky130_fd_sc_hd__buf_1 _073_ (.A(_037_),
    .X(an[1]));
 sky130_fd_sc_hd__or2b_2 _074_ (.A(\display_module.pos[0] ),
    .B_N(\display_module.pos[1] ),
    .X(_038_));
 sky130_fd_sc_hd__buf_1 _075_ (.A(_038_),
    .X(an[2]));
 sky130_fd_sc_hd__nand2_2 _076_ (.A(\display_module.pos[0] ),
    .B(\display_module.pos[1] ),
    .Y(an[3]));
 sky130_fd_sc_hd__or4b_2 _077_ (.A(\display_module.counter[17] ),
    .B(\display_module.counter[19] ),
    .C(\display_module.counter[18] ),
    .D_N(\display_module.counter[16] ),
    .X(_039_));
 sky130_fd_sc_hd__or4b_2 _078_ (.A(\display_module.counter[13] ),
    .B(\display_module.counter[12] ),
    .C(\display_module.counter[14] ),
    .D_N(\display_module.counter[15] ),
    .X(_040_));
 sky130_fd_sc_hd__nand2_2 _079_ (.A(\display_module.counter[5] ),
    .B(\display_module.counter[7] ),
    .Y(_041_));
 sky130_fd_sc_hd__or4bb_2 _080_ (.A(\display_module.counter[3] ),
    .B(\display_module.counter[2] ),
    .C_N(\display_module.counter[9] ),
    .D_N(\display_module.counter[10] ),
    .X(_042_));
 sky130_fd_sc_hd__or4_2 _081_ (.A(\display_module.counter[1] ),
    .B(\display_module.counter[0] ),
    .C(_041_),
    .D(_042_),
    .X(_043_));
 sky130_fd_sc_hd__or4_2 _082_ (.A(\display_module.counter[4] ),
 ...
 sky130_fd_sc_hd__nor4_2 _083_ (.A(_039_),
    ...
    .D(_044_),
    .Y(_045_));
 sky130_fd_sc_hd__nor2_2 _084_ (.A(\display_module.counter[0] ),
    .B(_045_),
    .Y(_000_));
 sky130_fd_sc_hd__or2_2 _085_ (.A(\display_module.counter[1] ),
    .B(\display_module.counter[0] ),
    .X(_046_));
 sky130_fd_sc_hd__nand2_2 _086_ (.A(\display_module.counter[1] ),
    .B(\display_module.counter[0] ),
    .Y(_047_));
 sky130_fd_sc_hd__and2_2 _087_ (.A(_046_),
    .B(_047_),
    .X(_048_));
 sky130_fd_sc_hd__buf_1 _088_ (.A(_048_),
    .X(_001_));
 sky130_fd_sc_hd__xnor2_2 _089_ (.A(\display_module.counter[2] ),
    .B(_047_),
    .Y(_002_));
 sky130_fd_sc_hd__and4_2 _090_ (.A(\display_module.counter[1] ),
    .B(\display_module.counter[0] ),
    .C(\display_module.counter[3] ),
    .D(\display_module.counter[2] ),
    .X(_049_));
 sky130_fd_sc_hd__a31o_2 _091_ (.A1(\display_module.counter[1] ),
    .A2(\display_module.counter[0] ),
    .A3(\display_module.counter[2] ),
    .B1(\display_module.counter[3] ),
    .X(_050_));
 sky130_fd_sc_hd__and2b_2 _092_ (.A_N(_049_),
    .B(_050_),
    .X(_051_));
 sky130_fd_sc_hd__buf_1 _093_ (.A(_051_),
    .X(_003_));
 sky130_fd_sc_hd__xor2_2 _094_ (.A(\display_module.counter[4] ),
    .B(_049_),
    .X(_004_));
 sky130_fd_sc_hd__and3_2 _095_ (.A(\display_module.counter[4] ),
    .B(\display_module.counter[5] ),
    .C(_049_),
    .X(_052_));
 sky130_fd_sc_hd__a21oi_2 _096_ (.A1(\display_module.counter[4] ),
    .A2(_049_),
    .B1(\display_module.counter[5] ),
    .Y(_053_));
 sky130_fd_sc_hd__nor3_2 _097_ (.A(_045_),
    .B(_052_),
    .C(_053_),
    .Y(_005_));
 sky130_fd_sc_hd__and4_2 _098_ (.A(\display_module.counter[4] ),
    .B(\display_module.counter[5] ),
    .C(\display_module.counter[6] ),
    .D(_049_),
    .X(_054_));
 sky130_fd_sc_hd__nor2_2 _099_ (.A(\display_module.counter[6] ),
    .B(_052_),
    .Y(_055_));
 sky130_fd_sc_hd__nor2_2 _100_ (.A(_054_),
    .B(_055_),
    .Y(_006_));
 sky130_fd_sc_hd__and2_2 _101_ (.A(\display_module.counter[7] ),
    .B(_054_),
    .X(_056_));
 sky130_fd_sc_hd__buf_1 _102_ (.A(_056_),
    .X(_057_));
 sky130_fd_sc_hd__nor2_2 _103_ (.A(_045_),
    .B(_057_),
    .Y(_058_));
 sky130_fd_sc_hd__o21a_2 _104_ (.A1(\display_module.counter[7] ),
    .A2(_054_),
    .B1(_058_),
    .X(_007_));
 sky130_fd_sc_hd__xor2_2 _105_ (.A(\display_module.counter[8] ),
    .B(_057_),
    .X(_008_));
 sky130_fd_sc_hd__a21oi_2 _106_ (.A1(\display_module.counter[8] ),
    .A2(_057_),
    .B1(\display_module.counter[9] ),
    .Y(_059_));
 sky130_fd_sc_hd__a311oi_2 _107_ (.A1(\display_module.counter[8] ),
    .A2(\display_module.counter[9] ),
    .A3(_057_),
    .B1(_059_),
    .C1(_045_),
    .Y(_009_));
 sky130_fd_sc_hd__a31o_2 _108_ (.A1(\display_module.counter[8] ),
    .A2(\display_module.counter[9] ),
    .A3(_057_),
    .B1(\display_module.counter[10] ),
    .X(_060_));
 sky130_fd_sc_hd__and3_2 _109_ (.A(\display_module.counter[8] ),
    .B(\display_module.counter[9] ),
    .C(\display_module.counter[10] ),
    .X(_061_));
 sky130_fd_sc_hd__and3_2 _110_ (.A(\display_module.counter[7] ),
    .B(_054_),
    .C(_061_),
    .X(_062_));
 sky130_fd_sc_hd__inv_2 _111_ (.A(_062_),
    .Y(_063_));
 sky130_fd_sc_hd__and3b_2 _112_ (.A_N(_045_),
    .B(_060_),
    .C(_063_),
    .X(_064_));
 sky130_fd_sc_hd__buf_1 _113_ (.A(_064_),
    .X(_010_));
 sky130_fd_sc_hd__and4_2 _114_ (.A(\display_module.counter[7] ),
    .B(\display_module.counter[11] ),
    .C(_054_),
    .D(_061_),
    .X(_065_));
 sky130_fd_sc_hd__buf_1 _115_ (.A(_065_),
    .X(_066_));
 sky130_fd_sc_hd__nor2_2 _116_ (.A(\display_module.counter[11] ),
    .B(_062_),
    .Y(_067_));
 sky130_fd_sc_hd__nor2_2 _117_ (.A(_066_),
    .B(_067_),
    .Y(_011_));
 sky130_fd_sc_hd__xor2_2 _118_ (.A(\display_module.counter[12] ),
    .B(_066_),
    .X(_012_));
 sky130_fd_sc_hd__a21oi_2 _119_ (.A1(\display_module.counter[12] ),
    .A2(_066_),
    .B1(\display_module.counter[13] ),
    .Y(_068_));
 sky130_fd_sc_hd__and3_2 _120_ (.A(\display_module.counter[13] ),
    .B(\display_module.counter[12] ),
    .C(_066_),
    .X(_069_));
 sky130_fd_sc_hd__nor2_2 _121_ (.A(_068_),
    .B(_069_),
    .Y(_013_));
 sky130_fd_sc_hd__and2_2 _122_ (.A(\display_module.counter[13] ),
    .B(\display_module.counter[12] ),
    .X(_022_));
 sky130_fd_sc_hd__and3_2 _123_ (.A(\display_module.counter[14] ),
    .B(_066_),
    .C(_022_),
    .X(_023_));
 sky130_fd_sc_hd__o21ba_2 _124_ (.A1(\display_module.counter[14] ),
    .A2(_069_),
    .B1_N(_023_),
    .X(_014_));
 sky130_fd_sc_hd__nor2_2 _125_ (.A(\display_module.counter[15] ),
    .B(_023_),
    .Y(_024_));
 sky130_fd_sc_hd__and4_2 _126_ (.A(\display_module.counter[14] ),
    .B(\display_module.counter[15] ),
    .C(_066_),
    .D(_022_),
    .X(_025_));
 sky130_fd_sc_hd__nor3_2 _127_ (.A(_045_),
    .B(_024_),
    .C(_025_),
    .Y(_015_));
 sky130_fd_sc_hd__or2_2 _128_ (.A(\display_module.counter[16] ),
    .B(_025_),
    .X(_026_));
 sky130_fd_sc_hd__nand2_2 _129_ (.A(\display_module.counter[16] ),
    .B(_025_),
    .Y(_027_));
 sky130_fd_sc_hd__and3b_2 _130_ (.A_N(_045_),
    .B(_026_),
    .C(_027_),
    .X(_028_));
 sky130_fd_sc_hd__buf_1 _131_ (.A(_028_),
    .X(_016_));
 sky130_fd_sc_hd__xnor2_2 _132_ (.A(\display_module.counter[17] ),
    .B(_027_),
    .Y(_017_));
 sky130_fd_sc_hd__and4_2 _133_ (.A(\display_module.counter[17] ),
    .B(\display_module.counter[16] ),
    .C(\display_module.counter[18] ),
    .D(_025_),
    .X(_029_));
 sky130_fd_sc_hd__a31o_2 _134_ (.A1(\display_module.counter[17] ),
    .A2(\display_module.counter[16] ),
    .A3(_025_),
    .B1(\display_module.counter[18] ),
    .X(_030_));
 sky130_fd_sc_hd__and2b_2 _135_ (.A_N(_029_),
    .B(_030_),
    .X(_031_));
 sky130_fd_sc_hd__buf_1 _136_ (.A(_031_),
    .X(_018_));
 sky130_fd_sc_hd__xor2_2 _137_ (.A(\display_module.counter[19] ),
    .B(_029_),
    .X(_019_));
 sky130_fd_sc_hd__or2_2 _138_ (.A(\display_module.pos[0] ),
    .B(_045_),
    .X(_032_));
 sky130_fd_sc_hd__nand2_2 _139_ (.A(\display_module.pos[0] ),
    .B(_045_),
    .Y(_033_));
 sky130_fd_sc_hd__and2_2 _140_ (.A(_032_),
    .B(_033_),
    .X(_034_));
 sky130_fd_sc_hd__buf_1 _141_ (.A(_034_),
    .X(_020_));
 sky130_fd_sc_hd__and3b_2 _142_ (.A_N(\display_module.pos[1] ),
    .B(_045_),
    .C(\display_module.pos[0] ),
    .X(_035_));
 sky130_fd_sc_hd__a21o_2 _143_ (.A1(\display_module.pos[1] ),
    .A2(_033_),
    .B1(_035_),
    .X(_021_));
 ...
 sky130_fd_sc_hd__conb_1 _166_ (.HI(seg[6]));
 sky130_fd_sc_hd__conb_1 _167_ (.LO(seg[0]));
 sky130_fd_sc_hd__conb_1 _168_ (.LO(seg[1]));
 sky130_fd_sc_hd__conb_1 _169_ (.LO(seg[2]));
 sky130_fd_sc_hd__conb_1 _170_ (.LO(seg[3]));
 sky130_fd_sc_hd__conb_1 _171_ (.LO(seg[4]));
 sky130_fd_sc_hd__conb_1 _172_ (.LO(seg[5]));
