module TopModule (clk,
 ...
 sky130_fd_sc_hd__conb_1 _166_ (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(seg[6]));
 sky130_fd_sc_hd__conb_1 _167_ (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(seg[0]));
 sky130_fd_sc_hd__conb_1 _168_ (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(seg[1]));
 sky130_fd_sc_hd__conb_1 _169_ (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(seg[2]));
 sky130_fd_sc_hd__conb_1 _170_ (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(seg[3]));
 sky130_fd_sc_hd__conb_1 _171_ (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(seg[4]));
 sky130_fd_sc_hd__conb_1 _172_ (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(seg[5]));
